...
import static r.rural.awaassakhi.utils.Constants.CRYPT_ID;
...
import r.rural.awaassakhi.utils.Constants;
...
public class CryptLib {
    ...
    public String encrypt(String _plainText)
        ...
        String encAesKey = AppPreferencesManager.getInstance().getString(Constants.ENC_AES_KEY);

        encAesKey = TextUtils.isEmpty(encAesKey) ? CRYPT_ID : encAesKey;

        return encryptDecrypt(_plainText, encAesKey, EncryptMode.ENCRYPT, encAesKey);
    }
    ...
    public String decrypt(String _encryptedText)
        ...
        return encryptDecrypt(_encryptedText, encAesKey, EncryptMode.DECRYPT, encAesKey);
    }

    public String decrypt(String _encryptedText, String key)
            throws InvalidKeyException, UnsupportedEncodingException,
            InvalidAlgorithmParameterException, IllegalBlockSizeException,
            BadPaddingException {


        return encryptDecrypt(_encryptedText, key, EncryptMode.DECRYPT, key);
    }
